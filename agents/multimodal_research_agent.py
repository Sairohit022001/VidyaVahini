...
class MultimodalResearchAgent(Agent):
    def __init__(self, *args, name: str = "multimodal_research_agent", **kwargs):
        super().__init__(
            *args,
            name=name,
            role="""
    ...
    async def process(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Args:
            inputs (Dict[str, Any]): Should include 'topic', 'grade', and optional 'context_from_doc'.

        Returns:
            Dict[str, Any]: Research resources including papers, videos, and trusted websites.
        """
        try:
            ...
            multimodal_task_instance = MultimodalResearchTask(
                name=MultimodalResearchTask.name,
                description=MultimodalResearchTask.description
            )
