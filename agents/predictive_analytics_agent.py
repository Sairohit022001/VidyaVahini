...
class PredictiveAnalyticsAgent(Agent):
    def __init__(self, *args, name: str = "predictive_analytics_agent", **kwargs):
        predictive_task = PredictiveAnalyticsTask(
            name=PredictiveAnalyticsTask.name,
            description=PredictiveAnalyticsTask.description
        )
        ...
        self._name = name
        self.predictive_task_instance = predictive_task
    ...
    async def process(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Args:
            inputs (Dict[str, Any]): Should include 'quiz_results' and optional 'context_from_doc'.

        Returns:
            Dict[str, Any]: Predictive analytics insights including average score, top performers, weak areas, and suggestions.
        """
        try:
            ...
            # Use the saved task instance to run predictive analytics
            result = await self.predictive_task_instance.run(context)
            return result
